...
class MainWindow(QMainWindow):
	...
	def openFile(self):
		...
		if fileChoosen != None:
			...
			u = fileChoosen[0].toString().split("/")
			g = len(u[len(u)-1])
			print("".join(u))
			print(fileChoosen[0].toString()[8:len(fileChoosen[0].toString())-g]+"hh.mp3")
	...
	def prevItemPlaylist(self):
		...
		info.setGeometry(500,500,1000,500)
		info.setWindowTitle("Bilgilendirme")
		info.setIcon(QMessageBox.Information)
		info.setText("Bilgilendirme")
		info.setInformativeText("Karşı Cihazın Dosyayı Almaya Hazır Olduğundan Emin Olun")
		info.show()
	...
	def nextItemPlaylist(self):
		...
		box.setText('Lütfen Göndermeden Önce Karşı Cihazın Almaya Hazır Olup Olmadığını Kontrol Edin.')
		box.setStandardButtons(QMessageBox.Yes)
		buttonY = box.button(QMessageBox.Yes)
		buttonY.setText('Devam')
		box.exec_()
